...
You finished everything you have to do in [translationdata.json](./translationdata.json) lets move on!(Doubts? Click see Translationdata.json example at the bottom of this md)
### Settings.html
